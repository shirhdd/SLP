...
def predict():
    ...
    if file and file.filename.endswith('.wav'):
        try:
            ...
            audio_resampled = resampy.resample(audio, original_sample_rate, 16000)
            ...
            return jsonify({'message': 'File processed and resampled to 16000 Hz', 'filename': output_filename}), 200
